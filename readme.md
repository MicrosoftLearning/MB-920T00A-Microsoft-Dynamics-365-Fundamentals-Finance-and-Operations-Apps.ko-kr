# MB-920: Microsoft Dynamics 365 기본 재무 및 운영 앱
...
- Dynamics가 변경되고 라이브 배달 중에 먼저 찾을 때 랩 원본에서 바로 향상된 기능을 제공하는 등 이전에는 없었던 것처럼 랩에 공동 작업을 수행할 수 있기를 바랍니다.  동료 MCT를 도와주세요.
...
- 문제, 변경 내용, 개선 사항 및 아이디어를 제출할 수 있습니다.  이전에 새 Dynamics 기능을 찾으시겠습니까?  새로운 데모를 제출해 주세요!
