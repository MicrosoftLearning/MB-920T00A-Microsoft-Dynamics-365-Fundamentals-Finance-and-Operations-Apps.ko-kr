...
이 랩에서는 Dynamics Data 커넥트or office 추가 기능 앱을 사용하여 재무 및 운영에서 Excel로 데이터를 복사하는 방법을 알아봅니다. 또한 동일한 앱을 사용하여 Dynamics 365 Finance and Operations에 데이터를 삽입하는 방법을 알아봅니다. 
